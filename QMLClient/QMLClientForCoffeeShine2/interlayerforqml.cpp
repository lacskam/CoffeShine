...
void InterlayerForQML::connectToHost_Slot()
{
    ...
    connect(drinkImageProvider, &DrinkImageProvider::signalGetImageFromDB, this, &InterlayerForQML::getImageFromDB_Slot);
    connect(this, &InterlayerForQML::sendImageFromDB_Signal, drinkImageProvider, &DrinkImageProvider::slotGetImageFromDB);

    connect(client, &QUnNetProtokolCLient::signalConnected, this, &InterlayerForQML::slotConnected);
    connect(client, &QUnNetProtokolCLient::signalDisconnected, this, &InterlayerForQML::slotDisconnected);
    connect(client, &QUnNetProtokolCLient::signalAuthorized, this, &InterlayerForQML::slotAuthorized);
    connect(client, &QUnNetProtokolCLient::signalUserInfoReceived, this, &InterlayerForQML::slotUserInfoReceived);
    connect(client, &QUnNetProtokolCLient::signalError, this, &InterlayerForQML::slotError);
